...
class Usuario(AbstractUser):
    ...
    tema = models.CharField(max_length=20, default='system') # light, dark, system
    ...
    orden_formularios = models.JSONField(default=dict, blank=True) # Guarda el orden de los campos al crear/editar
...
class Solicitud(models.Model):
    ...
    # NUEVOS CAMPOS: Especifican la DB exacta
...
class RegistroIntegridad(models.Model):
    ...
    equipo = models.CharField(max_length=200) # Corresponde al Producto
    ...
    # Metadatos para sincronización con MongoDB
...
class HistorialCambio(models.Model):
    ...
    datos_extra = models.JSONField(blank=True, null=True) # Para guardar el JSON del producto borrado
